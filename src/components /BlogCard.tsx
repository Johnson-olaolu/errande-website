    ...
    <div className=" w-full max-w-96">
      <div className=" relative mb-4">
        ...
        <div className=" absolute top-5 right-5 bg-erande-blue-opacity-15 px-5 py-3 rounded-full">
          <span className=" text-erande-blue font-antipasto-pro font-medium">News</span>
        </div>
      </div>
      <div className=" text-erande-blue">
        <p className=" mb-5 text-sm font-futura-pt">29 JAN 2025 - 10mins Read</p>
        <p className=" text-3xl font-antipasto-pro capitalize ">Financial ways in moving forward from porverty.</p>
        <p className="  text-sm font-futura-pt">
