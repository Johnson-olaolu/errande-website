  ...
  return (
    <div className="">
          ...
          <div className="absolute w-screen h-20 lg:h-36 bg-erande-blue bottom-0 left-0 transform translate-y-full lg:translate-y-1/2 z-[2] flex items-center overflow-hidden">
            ...
            >
              <div className="flex items-center gap-20">
                <span className=" text-2xl lg:text-5xl font-brigands-expanded uppercase text-white ml-20">Errands</span>
                <ShopIcon className="text-white h-8 w-8 lg:h-[60px] lg:w-[60px]" />
                <span className=" text-2xl lg:text-5xl font-brigands-expanded uppercase text-white">Deliveries</span>
                <ShopIcon className="text-white h-8 w-8 lg:h-[60px] lg:w-[60px]" />
                <span className=" text-2xl lg:text-5xl font-brigands-expanded uppercase text-white">Services</span>
                <ShopIcon className="text-white h-8 w-8 lg:h-[60px] lg:w-[60px]" />
              </div>
              <div className="flex items-center gap-20">
                <span className=" text-2xl lg:text-5xl font-brigands-expanded uppercase text-white ml-20">Errands</span>
      ...
      <div className=" flex items-center justify-center mt-16 gap-3">
        <div className="px-5 lg:px-8 py-3 lg:py-5 bg-erande-red rounded-full text-white font-antipasto-pro text-base lg:text-2xl">Customers</div>
