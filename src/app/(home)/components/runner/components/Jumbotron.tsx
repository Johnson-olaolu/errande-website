...
// Jumbotron component for the runner page
  ...
  return (
    <div className="">
        ...
        <div className="bg-erande-red pt-28 lg:pt-52 px-5 lg:px-24 h-[594px] lg:h-[800px] relative z-0">
          <div className="z-[1]">
            <div className=" flex items-center justify-center gap-2.5 lg:gap-5 mb-9 lg:mb-3">
              <a href="" className="">
                <Image
                  className="h-8 lg:h-14 w-11 lg:w-20"
            ...
            <div className=" flex flex-col lg:flex-row justify-between gap-2.5 items-center lg:items-start">
              ...
              <div className="max-w-[330px] lg:max-w-[278px] w-full text-center lg:text-right">
                <p className=" capitalize text-sm lg:text-lg font-antipasto-pro text-white">
                  Our service offers rapid, dependable errand and delivery
                  solutions, ensuring your tasks are completed efficiently and
                  timely.
                </p>
              </div>
            </div>
          ...
          <div className=" absolute top-[300px] left-1/2 transform -translate-x-1/2 z-[0]">
            <p className="uppercase font-brigands-expanded text-[108px] lg:text-[280px] text-opacity-15">
              ERANDE
            </p>
          </div>
          <div className="h-[442px] lg:h-[690px] w-[442px] lg:w-[690px] rounded-full bg-erande-red absolute bottom-0 left-1/2 transform -translate-x-1/2 translate-y-[180px] lg:translate-y-[200px] z-[1]">
            <Image
              ...
              alt="rider"
              className=" absolute -top-3 lg:-top-8 left-1/2 transform -translate-x-1/2 h-[340px] lg:h-[554px]  w-auto"
              height={554}
              width={562}
            />
          ...
          <div className="absolute w-screen h-20 lg:h-36 bg-erande-blue bottom-0 left-0 transform translate-y-full lg:translate-y-1/2 z-[2] flex items-center overflow-hidden">
            <motion.div
            ...
            >
              <div className="flex items-center gap-20">
                <span className=" text-2xl lg:text-5xl font-brigands-expanded uppercase text-white ml-20">
                  Errands
                </span>
                <ShopIcon className="text-white h-8 w-8 lg:h-[60px] lg:w-[60px]" />
                <span className=" text-2xl lg:text-5xl font-brigands-expanded uppercase text-white">
                  Deliveries
                </span>
                <ShopIcon className="text-white h-8 w-8 lg:h-[60px] lg:w-[60px]" />
                <span className=" text-2xl lg:text-5xl font-brigands-expanded uppercase text-white">
      ...
      <div className=" flex items-center justify-center mt-16 gap-3">
        <div className="px-5 lg:px-8 py-3 lg:py-5 bg-erande-red rounded-full text-white font-antipasto-pro text-base lg:text-2xl">
          Customers
        </div>
        <button
          onClick={() => nextSection()}
          className="p-3 lg:p-5 border-2 border-erande-red rounded-full cursor-pointer "
        >
