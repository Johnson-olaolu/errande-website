    ...
    <div className="">
      <div className=" pb-[200px] overflow-x-hidden">
        <div className="bg-erande-black pt-28 lg:pt-52 px-5 lg:px-24 h-[594px] lg:h-[800px] relative z-0">
            ...
            <div className=" flex flex-col lg:flex-row justify-between gap-2.5 items-center lg:items-start">
              <div className=" max-w-[330px] lg:max-w-[456px] w-full text-center lg:text-left">
                <p className=" capitalize text-2xl lg:text-4xl font-antipasto-pro text-white">
                  increase your sales, <br /> make more money!
                </p>
              </div>
              <div className="max-w-[330px] lg:max-w-[278px] w-full text-center lg:text-right">
                <p className=" capitalize text-sm lg:text-lg font-antipasto-pro text-white">
                  Eliminate long wait times with Erande. Connect directly with customers and boost your sales. Simplify your operations and grow
                  effortlessly. Join Erande today!
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="h-[442px] lg:h-[690px] w-[442px] lg:w-[690px] rounded-full bg-erande-black absolute bottom-0 left-1/2 transform -translate-x-1/2 translate-y-[180px] lg:translate-y-[200px] z-[1]">
            <Image
              src="/images/shop.png"
              alt="shop"
              className=" absolute -top-8 lg:-top-12 left-1/2 transform -translate-x-1/2 h-[340px] lg:h-[539px] lg:w-[855px] object-cover"
              height={539}
              width={855}
            />
