    ...
    <div className="">
      <div className=" pb-[200px] overflow-x-hidden">
        <div className="bg-erande-blue pt-28 lg:pt-52 px-5 lg:px-24 h-[594px] lg:h-[800px] relative z-0">
          <div className="z-[1]">
            ...
            <div className=" flex flex-col lg:flex-row justify-between gap-2.5 items-center lg:items-start">
              <div className=" max-w-[330px] lg:max-w-[456px] w-full text-center lg:text-left">
                <p className=" capitalize text-2xl lg:text-4xl font-antipasto-pro">
                  Fast, reliable errand and delivery services.
                </p>
              </div>
              <div className="max-w-[330px] lg:max-w-[278px] w-full text-center lg:text-right">
                <p className=" capitalize text-sm lg:text-lg font-antipasto-pro">
          ...
          <div className="h-[442px] lg:h-[690px] w-[442px] lg:w-[690px] rounded-full bg-erande-darkblue absolute bottom-0 left-1/2 transform -translate-x-1/2 translate-y-[180px] lg:translate-y-[200px] z-[1]">
            <Image
          ...
          <div className="absolute w-screen h-20 lg:h-36 bg-[#E03826] bottom-0 left-0 transform translate-y-full lg:translate-y-1/2 z-[2] flex items-center overflow-hidden">
            ...
            >
              <div className="flex items-center gap-20">
                <span className=" text-2xl lg:text-5xl font-brigands-expanded uppercase text-[#FFBB00] ml-20">
                  Errands
                </span>
                <ShopIcon className="text-[#FFBB00] h-8 w-8 lg:h-[60px] lg:w-[60px]" />
                <span className=" text-2xl lg:text-5xl font-brigands-expanded uppercase text-[#FFBB00]">
                  Deliveries
                </span>
                <ShopIcon className="text-[#FFBB00] h-8 w-8 lg:h-[60px] lg:w-[60px]" />
                <span className=" text-2xl lg:text-5xl font-brigands-expanded uppercase text-[#FFBB00]">
      ...
      <div className=" flex items-center justify-center mt-16 gap-3">
        <div className="px-5 lg:px-8 py-3 lg:py-5 bg-erande-blue rounded-full text-white font-antipasto-pro text-base lg:text-2xl">
          Customers
        </div>
        <button
          onClick={() => nextSection()}
          className="p-3 lg:p-5 border-2 border-erande-blue rounded-full cursor-pointer "
        >
