  ...
  return (
    <div className="">
      ...
      <div className=" flex items-center justify-center mt-16 gap-3">
        <div className="px-8 py-5 bg-erande-red rounded-full text-white font-antipasto-pro text-2xl">Customers</div>
        <button className="p-5 border-2 border-erande-red rounded-full ">
